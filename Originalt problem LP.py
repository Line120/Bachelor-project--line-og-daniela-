...
fil_sti = "C:/Users/linef/Documents/Bachelor projektet/Datasæt/A-n36-k11.txt"
# Opret ny model
m = gp.Model()
...
tolerance = 0.0001  # Små værdier under 0.0001 ignoreres
for i in I:
   for j in J:
       for k in K:
           if x[i, j, k].X > tolerance:
               print(f"Værdi af x_{i},{j}^{k}: {x[i, j, k].X:.4f}")
